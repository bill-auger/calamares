...
quint16 fichePort = 9999;           // TODO: config var
    ...
    QString pasteUrlFmt = tr( "Install log posted to: %1" );
    ...
    connect( msgBox, &QMessageBox::buttonClicked,
             [msgBox, ficheHost, fichePort] ( QAbstractButton* button )
    {
        ...
        QUrl pasteUrl = QUrl( QString( resp ), QUrl::StrictMode );
        ...
        pasteUrlMsgBox->setInformativeText( pasteUrlMsg );
        pasteUrlMsgBox->show();
